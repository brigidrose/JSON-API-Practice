...
def find_afterparties():
    ...
    payload ={"token": "ZSGME5PHFMHS7BQB4KSG", "location": location, "distance": distance, "query": query}
    r = requests.get('https://www.eventbriteapi.com/v3/categories', params=payload)
    data = {'This': [location, query, distance]}
    events = []
